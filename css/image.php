...
<div class="MainMenu">
    ...
    <ul class="MainMenu_ul">
        <li><a class="aa" href="animation.php">Animation</a>
            <div class="line"></div>
        </li>
        <li><a class="aa" href="form.php">form</a>
            <div class="line"></div>
        </li>
        <li><a class="aa" href="Content_Box.php">Content_Box</a>
            <div class="line"></div>
        </li>
        <li><a class="aa" href="text_rotate.php">text_rotate</a>
            <div class="line"></div>
        </li>
        <li><a class="aa" href="animation.php">Contact</a>
            <div class="line"></div>
        </li>
    </ul>
    <div class="close">
...
<div class="wrapper">
    ...
    <div class="kate"><h3>My wife</h3></div>
    <div class="wrapper-card">
        <div class="card">
            <div class="face"></div>
            <div class="content">
                <h2>Lorem ipsum dolor sit.</h2>
                <p>Architecto asperiores beatae dolores,
                    dolorum esse exercitationem fuga, id, maxime optio qui ut veniam. Lorem ipsum dolor sit amet,
                    consectetur adipisicing elit. At dolor earum eos quo voluptate!
                    Eum minus molestiae mollitia nulla quae saepe vitae!
                </p>
            </div>
        </div>
    </div>
